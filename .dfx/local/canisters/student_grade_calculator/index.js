...
import { idlFactory } from './student_grade_calculator.did.js';
export { idlFactory } from './student_grade_calculator.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STUDENT_GRADE_CALCULATOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./student_grade_calculator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the student_grade_calculator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./student_grade_calculator.did.js")._SERVICE>}
 */
export const student_grade_calculator = createActor(canisterId);
